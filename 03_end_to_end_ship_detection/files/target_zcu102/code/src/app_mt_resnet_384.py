...
def main(argv):
    ...
    # CPU subgraph 2
    #######################################################
    input_imgs_dpu[2] = CPUZeroPad2d(output_imgs_dpu[1][1], cnt)
    #######################################################
    # DPU subgraph 2
    #######################################################
    inps = [output_imgs_dpu[1][1], input_imgs_dpu[2]]
    ...
    inps = [output_imgs_dpu[0][0], output_imgs_dpu[1][0],
            output_imgs_dpu[1][1], output_imgs_dpu[2][0], input_imgs_dpu[3]]
